...
class GridWorldContinuous(gym.Env):
    ...
    def __init__(self, dim=6, max_delta=0.2, wall_width=2.5):
        ...
        # The episode terminates if the goal is reached
        self.goal = BoundingBox(xmin=self.dim-4, xmax=self.dim, ymin=self.dim-4, ymax=self.dim)
    ...
    def _step(self, action):
        ...
        done = True if self.goal.check_if_inside(new_x, new_y) else False
        reward = -1
